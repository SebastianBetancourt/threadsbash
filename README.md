...
-m, --ModulateThreads LOWERBOUND UPPERBOUND Lets the program regulate the size of the thread pool dinamically, 
...
--MemoryUsagePerProcess MB                  How many megabytes of memory are the processes estimated to use 
