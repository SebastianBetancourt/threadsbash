...
-o PATHFILE                             Path to output file, where the equivalences will be registered 
                                        once they are determined. The dafault path is ~/output.txt.
-l PATHFILE                             Path to log file to append generated logging. The dafault log file
                                        is ~/log.txt.
...
--MemoryUsagePerProcess, -m MB          How many megabytes of memory are the processes estimated to use 
